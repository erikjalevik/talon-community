...
symbols = [
    ...
    Symbol("+", None, ["plus"]),
    Symbol("~", None, ["tilde"]),
    Symbol("_", None, ["underscore", "low dash"]),
    Symbol("(", ["paren",], ["frown"]),
    Symbol(")", ["right paren"], ["smile"]),
    Symbol("[", None, ["bracket", "hooky"],),
    Symbol("]", None, ["right bracket", "wookie"]),
    Symbol("/", ["forward slash"], ["slash"]),
    Symbol("\\", None, ["backslash"]),
    Symbol("{", None, ["brace", "curly"],),
    Symbol("}", None, ["right brace", "whirly"]),
    Symbol("<", None, ["angle", "less than"]),
