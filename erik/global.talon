...
erase: user.delete_word_left_n(1)
erase <number_small> [times | ex]: user.delete_word_left_n(number_small)
consume: user.delete_word_right_n(1)
consume <number_small> [times | ex]: user.delete_word_right_n(number_small)
wipe: edit.delete_line()
scratch that: user.clear_last_phrase()
clone: edit.line_clone()
